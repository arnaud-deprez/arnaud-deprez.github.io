...
type MdxFrontmatterFilterInput = {
  ...
  readonly description: Maybe<StringQueryOperatorInput>;
  readonly image: Maybe<MdxFrontmatterImageFilterInput>;
...
type FileFieldsEnum =
  ...
  | 'childrenMdx.frontmatter.image.caption'
  ...
  | 'childMdx.frontmatter.image.caption'
...
type MdxFieldsEnum =
  ...
  | 'frontmatter.image.src.sourceInstanceName'
  | 'frontmatter.image.src.absolutePath'
  | 'frontmatter.image.src.relativePath'
  | 'frontmatter.image.src.extension'
  | 'frontmatter.image.src.size'
  | 'frontmatter.image.src.prettySize'
  | 'frontmatter.image.src.modifiedTime'
  | 'frontmatter.image.src.accessTime'
  | 'frontmatter.image.src.changeTime'
  | 'frontmatter.image.src.birthTime'
  | 'frontmatter.image.src.root'
  | 'frontmatter.image.src.dir'
  | 'frontmatter.image.src.base'
  | 'frontmatter.image.src.ext'
  | 'frontmatter.image.src.name'
  | 'frontmatter.image.src.relativeDirectory'
  | 'frontmatter.image.src.dev'
  | 'frontmatter.image.src.mode'
  | 'frontmatter.image.src.nlink'
  | 'frontmatter.image.src.uid'
  | 'frontmatter.image.src.gid'
  | 'frontmatter.image.src.rdev'
  | 'frontmatter.image.src.ino'
  | 'frontmatter.image.src.atimeMs'
  | 'frontmatter.image.src.mtimeMs'
  | 'frontmatter.image.src.ctimeMs'
  | 'frontmatter.image.src.atime'
  | 'frontmatter.image.src.mtime'
  | 'frontmatter.image.src.ctime'
  | 'frontmatter.image.src.birthtime'
  | 'frontmatter.image.src.birthtimeMs'
  | 'frontmatter.image.src.blksize'
  | 'frontmatter.image.src.blocks'
  | 'frontmatter.image.src.publicURL'
  | 'frontmatter.image.src.childrenImageSharp'
  | 'frontmatter.image.src.childrenMdx'
  | 'frontmatter.image.src.id'
  | 'frontmatter.image.src.children'
...
type SiteInformationFragment = (
  Pick<Site, 'buildTime'>
  & { readonly siteMetadata: Maybe<(
    Pick<SiteSiteMetadata, 'title' | 'description' | 'siteUrl' | 'copyright' | 'repository' | 'disqusShortName'>
    & { readonly author: Maybe<Pick<SiteSiteMetadataAuthor, 'name' | 'jobTitle' | 'email' | 'github' | 'linkedin' | 'twitter'>> }
  )> }
);
...
type SiteMetaDataQuery = { readonly site: Maybe<SiteInformationFragment> };
...
type BlogPostPageQuery = { readonly site: Maybe<SiteInformationFragment>, readonly mdx: Maybe<(
    Pick<Mdx, 'tableOfContents' | 'timeToRead' | 'body' | 'excerpt'>
    & { readonly frontmatter: Maybe<(
      Pick<MdxFrontmatter, 'date' | 'title' | 'description' | 'tags'>
      & { dateString: MdxFrontmatter['date'] }
      & { readonly image: Maybe<(
        Pick<MdxFrontmatterImage, 'caption'>
        & { readonly src: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> }
      )> }
    )>, readonly parent: Maybe<Pick<File, 'relativePath'>> }
  )> };

type BlogListByTagQueryVariables = Exact<{
  tag: Scalars['String'];
  skip: Scalars['Int'];
  limit: Scalars['Int'];
}>;
...
type BlogListByTagQuery = { readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<Mdx, 'timeToRead' | 'excerpt'>
        & { readonly fields: Maybe<Pick<MdxFields, 'slug'>>, readonly frontmatter: Maybe<(
          Pick<MdxFrontmatter, 'date' | 'title' | 'description' | 'tags'>
          & { dateString: MdxFrontmatter['date'] }
          & { readonly image: Maybe<{ readonly src: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> }> }
        )> }
      ) }> } };
...
type ContactPageQuery = { readonly site: Maybe<SiteInformationFragment> };
...
type BlogListQuery = { readonly site: Maybe<SiteInformationFragment>, readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<Mdx, 'timeToRead' | 'excerpt'>
        & { readonly fields: Maybe<Pick<MdxFields, 'slug'>>, readonly frontmatter: Maybe<(
          Pick<MdxFrontmatter, 'date' | 'title' | 'description' | 'tags'>
          & { dateString: MdxFrontmatter['date'] }
