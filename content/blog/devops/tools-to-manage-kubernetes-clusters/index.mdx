...
[stern](https://github.com/wercker/stern) and [kubetail](https://github.com/johanhaleby/kubetail) are 2 similar tools that allow you to `tail` multiple pods and containers within these pods into one single stream.
...
[K9s](https://github.com/derailed/k9s) provides a terminal UI to interact with your Kubernetes clusters. It makes it easier to navigate, observe and manage your applications in the wild. 
