...
I started my website few weeks ago and I always wanted to add a blog section and finally here it is :slightly_smiling_face:  
This first post shares my experience on using [Gatsby][gatsby] and [Netlify](https://www.netlify.com/) to build this and why I choose it over alternatives.
It does not explain how to get started with [Gatsby][gatsby], there are already a lot of other blogs and the [documentation](https://www.gatsbyjs.org/docs/) is really good with very good [tutorials](https://www.gatsbyjs.org/tutorial/).
...
Overall, this website is not finish yet and will continue to evolve, but I'm really happy with the current state and the fact that I can keep the code clean and focus on content and how I want to present it. Do not hesitate to check the source code on github and see you soon for other posts.

[^jamstack]:
  <u>JAMStack</u> is a modern architecture that uses <b>J</b>avaScript, <b>A</b>PIs and HTML <b>M</b>
  arkup (JAM) without requiring the use of a database or server-side programming language. More
  info <a href="https://jamstack.org/">https://jamstack.org/</a>

[^prpl]:
  <u>PRPL</u> is a web site architecture developed by Google for building websites and apps that work
